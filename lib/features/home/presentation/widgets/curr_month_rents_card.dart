      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 16.h),
            Divider(color: AppColors.secondBackground.withOpacity(0.2)),
            SizedBox(height: 16.h),
        ...
        Row(
          ...
          children: [
            ...
            BasicAppButton(
              ...
              width: 100.w,
              height: 40.h,
              disabled: latestRent != null &&
                  (latestRent.status == RentStatus.pending ||
                      latestRent.status == RentStatus.approved ||
                      latestRent.status == RentStatus.tracked),
            ),
          ],
        ),
        if (latestRent?.status == RentStatus.pending ||
            latestRent?.status == RentStatus.approved ||
            latestRent?.status == RentStatus.tracked) ...[
          SizedBox(height: 16.h),
          Text(
            "Pinjaman belum selesai, booking baru tidak bisa dilakukan.",
